...
namespace PromoPilot.Migrations
{
    ...
    [Migration("20250919102505_AddCustomerProductSalesTables")]
    partial class AddCustomerProductSalesTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PromoPilot.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("PromoPilot.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("PromoPilot.Models.Sale", b =>
                {
            ...
            modelBuilder.Entity("PromoPilot.Models.Sale", b =>
                {
                    ...
                    b.HasOne("PromoPilot.Models.Customer", "Customer")
                        .WithMany("Sales")
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PromoPilot.Models.Product", "Product")
                        .WithMany("Sales")
